<header class="<?php if (!isset($home_page)) {echo 'bg-gradient-to-tr from-green-700 to-green-400 shadow-lg';} else {echo 'text-white';} ?> relative">
    <div class="container max-w-7xl flex justify-between items-center mx-auto px-3 h-20">
        ...
        <?php
            if ($role === "user" || $role === "admin" || $role === "super_admin") {
                ...
                echo 
                '<nav>
                    <a href="/index.php" class="font-semibold text-md ml-4">Home</a>
                    <a href="/blogs.php" class="font-semibold text-md ml-4">Blogs</a>
