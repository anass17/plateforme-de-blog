...
<body class="overflow-y-scroll">
    ...
    <div class="max-w-7xl mx-auto px-3 py-10 grid gap-4 grid-cols-[25%_1fr] items-start">
        <div class="border border-gray-200 bg-gray-50 rounded-md px-5 py-7 shadow-md">
        ...
        <div id="option-blocks" class="shadow-md rounded-md bg-gray-50">
                        ...
                        while ($row = mysqli_fetch_assoc($posts)) {
                            ...
                            "<div class='mb-8'>
                                <div class='flex justify-between items-center'>
                                    ...
                                    <div class='flex gap-3'>
                                        <a href='/view.php?id={$row["post_id"]}&edit=1' class='px-4 py-2 rounded bg-gradient-to-tr from-blue-600 to-blue-400 shadow-lg flex gap-3 items-center'>
